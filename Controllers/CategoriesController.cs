...
namespace ChainStoreSystem.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(ChainStoreDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryName,CategoryStatus")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
