...
namespace ChainStoreSystem.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        {
            return View(await _context.Sub_Categorie.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SubCategoryName,SubCategoryStatus,Category_Fid")] SubCategory subCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SubCategoryName,SubCategoryStatus,Category_Fid")] SubCategory subCategory)
        {
