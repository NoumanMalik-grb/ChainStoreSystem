...
{
    public partial class AddOrerToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order_Name = table.Column<int>(type: "int", nullable: false),
                    Order_City = table.Column<int>(type: "int", nullable: false),
                    Order_Type = table.Column<int>(type: "int", nullable: false),
                    Order_Status = table.Column<int>(type: "int", nullable: false),
                    Order_Delivery_Status = table.Column<int>(type: "int", nullable: false),
